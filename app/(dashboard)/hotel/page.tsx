...
import { ArrowLeft, BedDouble, ShieldAlert } from "lucide-react";
            ...
            <div className="pb-24">
                <div className="w-full max-w-7xl mx-auto px-4 md:px-6 py-6">
                    ...
                    <motion.div
                        ...
                        className="relative overflow-hidden rounded-3xl border border-amber-500/15 p-6 md:p-10 text-center"
                        style={{ background: "linear-gradient(135deg, #0d1f12 0%, #0a1a0f 50%, #071209 100%)" }}
                    >
                        <div className="absolute -top-16 -right-16 w-60 h-60 bg-amber-500/10 rounded-full blur-[80px] pointer-events-none" />
                        <div className="absolute -bottom-10 -left-10 w-44 h-44 bg-amber-500/10 rounded-full blur-[60px] pointer-events-none" />

                        <div className="relative z-10 flex flex-col items-center gap-4 md:gap-5">
                            <div className="h-16 w-16 md:h-20 md:w-20 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400">
                                <BedDouble size={34} strokeWidth={1.8} />
                            </div>
