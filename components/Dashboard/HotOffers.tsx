...
import { Flame, ArrowRight, Gift, Zap } from "lucide-react";
...
const HotOffers = () => (
    <section className="space-y-3">
        ...
        <motion.div
            ...
            className="relative overflow-hidden rounded-2xl border border-amber-500/25 p-4"
        ...
        >
            ...
            <div className="relative z-10">
                ...
                <button className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-400 active:scale-95 text-black text-xs font-black px-4 py-2 rounded-xl transition-all shadow-[0_4px_16px_rgba(245,158,11,0.3)]">
        ...
        <div className="grid grid-cols-2 gap-3">
            ...
            <motion.div
                ...
                className="relative overflow-hidden rounded-2xl border border-teal-500/20 p-3.5"
            ...
            >
                ...
                <button className="w-full flex items-center justify-center gap-1.5 bg-teal-500/12 hover:bg-teal-500/20 text-teal-400 text-[10px] font-bold py-1.5 rounded-lg border border-teal-500/20 transition-all">
            ...
            <motion.div
                ...
                className="relative overflow-hidden rounded-2xl border border-rose-500/20 p-3.5"
            ...
            >
                ...
                <button className="w-full flex items-center justify-center gap-1.5 bg-rose-500/12 hover:bg-rose-500/20 text-rose-400 text-[10px] font-bold py-1.5 rounded-lg border border-rose-500/20 transition-all">
